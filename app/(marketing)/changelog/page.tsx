                    ...
                    new={[
                        {
                            ...
                            description: 'We now have a new chatbot SDK to help people build chatbots. The SDK is open source and can be used to build chatbots for any platform. Find out more about the SDK here https://sdk.smartbot-ai.com',
                        },
                    ]}
                    bugs={[
                        {
                    ...
                    <div className="flex flex-col gap-2">
                        {props.new?.map((item, index) => (
                            <div className="mb-2" key={`new-${index}`}>
                                <div className="font-bold pb-1 text-base">ðŸŽ‰ {item.title}</div>
                    ...
                    <div className="flex flex-col gap-2">
                        {props.improvements?.map((item, index) => (
                            <div className="mb-2" key={`improvements-${index}`}>
                                <div className="font-bold pb-1 text-base">ðŸš€ {item.title}</div>
                                <div className="text-neutral-500 text-sm pb-3">
                                    {item.description}
                                </div>
                                {item.image && (
                    ...
                    <div className="flex flex-col gap-2">
                        {props.bugs?.map((item, index) => (
                            <div className="mb-2" key={`bugs-${index}`}>
                                <div className="font-bold pb-1 text-base">ðŸ› {item.title}</div>
                                <div className="text-neutral-500 text-sm pb-3">
                                    {item.description}
                                </div>
                                {item.image && (
