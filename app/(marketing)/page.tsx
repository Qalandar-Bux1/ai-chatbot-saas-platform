          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="p-6">
              ...
              <CardContent className="space-y-2">
                ...
                <ul className="space-y-1">
                  <li>âœ“ {freePlan.maxChatbots} Chatbot</li>
                  <li>âœ“ {freePlan.maxCrawlers} Crawler</li>
                  <li>âœ“ {freePlan.maxFiles} Files</li>
                  <li>âœ“ {freePlan.maxMessagesPerMonth} Messages per Month</li>
                </ul>
              </CardContent>
            </Card>
            <Card className="p-6 border-2 border-primary relative">
              ...
              <CardContent className="space-y-2">
                ...
                <ul className="space-y-1">
                  <li>âœ“ {basicPlan.maxChatbots} Chatbots</li>
                  <li>âœ“ {basicPlan.maxCrawlers} Crawlers</li>
                  <li>âœ“ {basicPlan.maxFiles} Files</li>
                  <li>âœ“ Customizations</li>
                  <li>âœ“ Unlimited Messages</li>
                  <li>âœ“ Client Inquiry / Collect Leads</li>
                </ul>
              </CardContent>
            </Card>
            <Card className="p-6">
              ...
              <CardContent className="space-y-2">
                ...
                <ul className="space-y-1">
                  <li>âœ“ {proPlan.maxChatbots} Chatbots</li>
                  <li>âœ“ {proPlan.maxCrawlers} Crawlers</li>
                  <li>âœ“ {proPlan.maxFiles} Files</li>
                  <li>âœ“ Customizations</li>
                  <li>âœ“ Unlimited Messages</li>
                  <li>âœ“ Client Inquiry / Collect Leads</li>
                  <li>âœ“ Remove &apos;Powered by SmartBot AI&apos;</li>
                  <li>âœ“ Client File Attachment</li>
                </ul>
              </CardContent>
            </Card>
            <Card className="p-6">
              ...
              <CardContent className="space-y-2">
                ...
                <ul className="space-y-1">
                  ...
                  <li>âœ“ X Crawlers</li>
                  <li>âœ“ X Files</li>
                  <li>âœ“ All Features from other plans.</li>
                </ul>
              </CardContent>
            </Card>
          </div>
