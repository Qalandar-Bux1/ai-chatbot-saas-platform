document.addEventListener("DOMContentLoaded", function() {
    ...
    var targetDiv = document.getElementById("smartbot-ai-chatbot");
    if (!targetDiv) {
        console.error("Target div 'smartbot-ai-chatbot' not found.");
        return;
    }
    ...
    iframe.src = `https://smartbot-ai.com/embed/${chatbotId}/window?chatbox=false`;
