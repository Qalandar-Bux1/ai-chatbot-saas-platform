document.addEventListener("DOMContentLoaded", function () {
    (function () {
        ...
        buttonIframe.src = "https://www.smartbot-ai.com/embed/" + chatbotId + "/button?chatbox=false";
        ...
        buttonIframe.id = "smartbot-ai-chatbot-button-iframe";
        document.body.appendChild(buttonIframe);

        // Create and append the chat iframe
        var chatIframe = document.createElement('iframe');
        chatIframe.src = "https://www.smartbot-ai.com/embed/" + chatbotId + "/window?chatbox=false&withExitX=true";
        ...
        chatIframe.id = "smartbot-ai-chatbot-iframe";
        document.body.appendChild(chatIframe);

        // Add the event listener script
        window.addEventListener("message", function (t) {

            var e = document.getElementById("smartbot-ai-chatbot-iframe");
            var s = document.getElementById("smartbot-ai-chatbot-button-iframe");
